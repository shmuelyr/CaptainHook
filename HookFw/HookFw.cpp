#pragma optimize("", off)
#pragma warning(disable : 4293 4996)
...
*/
HookFw::HookFw(void **ppvSrc, void *pvDst, unsigned short nHookType) {
...
signed int HookFw::InitializeHookType(unsigned short nHookType) {
